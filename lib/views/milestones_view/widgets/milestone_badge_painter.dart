  ...
  void paint(Canvas canvas, Size size) {
    ...
    for (int layer = 0; layer < 3; layer++) {
      ...
      final paint = Paint()
        ..style = PaintingStyle.stroke
        ..strokeWidth = 2.5
        ..color = Colors.grey.withOpacity(0.6 - (layer * 0.15));
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final textPainter = TextPainter(
      text: TextSpan(
        text: text,
        style: TextStyle(
          color: (isCompleted && gradientColors != null) ? Colors.white : textColor,
...
class HeartPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    if (isCompleted && gradientColors != null) {
      ...
      leftArcPath.arcTo(
        Rect.fromCircle(center: Offset(center.dx - width * 0.45, center.dy - height * 0.4), radius: width * 0.5),
        -math.pi / 4,
        -math.pi / 2,
        false,
      );
  ...
  Path _createHeartPath(Offset center, double width, double height) {
    ...
    path.cubicTo(
      center.dx - width * 1.25, center.dy + height * 0.45,
      center.dx - width * 1.3, center.dy - height * 0.2,
      center.dx - width * 0.75, center.dy - height * 0.55,
    );
    path.cubicTo(
      center.dx - width * 0.4, center.dy - height * 0.8,
      center.dx - width * 0.15, center.dy - height * 0.8,
    ...
    path.cubicTo(
      center.dx + width * 1.3, center.dy - height * 0.2,
      center.dx + width * 1.25, center.dy + height * 0.45,
      center.dx, center.dy + height * 1.3,
    );
    path.close();
    return path;
  }
