...
class PodcastAudioPlayerController extends GetxController {
  ...
  final Rx<PodcastEpisodeModel?> _currentEpisode = Rx<PodcastEpisodeModel?>(null);
  final RxList<PodcastEpisodeModel> _relatedEpisodes = <PodcastEpisodeModel>[].obs;
  ...
  Future<void> _loadEpisodeData() async {
    try {
      ...
      _relatedEpisodes.value = (args['allEpisodes'] as List<PodcastEpisodeModel>?) ?? [];
  ...
  void _setupAudioListeners() {
    ...
    _audioPlayer.playerStateStream.listen((state) {
      ...
      _logger.i('🎵 Player state: playing=${state.playing}, processing=${state.processingState}');
