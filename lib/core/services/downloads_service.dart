...
class DownloadsService extends GetxService {
  ...
  Future<Directory> getDownloadsDirectory() async {
    ...
    print('📂 Downloads directory: ${customDir.path}');
    return customDir;
  }
  ...
  Future<void> _saveDownloadMetadata(
    ...
    try {
      ...
      print('💾 Metadata saved for: $itemId (user: ${_getCurrentUserId()})');
    } catch (e) {
  ...
  Future<Map<String, dynamic>> getDownloadedItems() async {
    try {
      ...
      print('📦 Loaded ${downloads.length} downloads for user: ${_getCurrentUserId()}');
      return downloads;
    } catch (e) {
  ...
  Future<void> clearAllDownloads() async {
    try {
      ...
      print('🗑️ All downloads cleared for user: ${_getCurrentUserId()}');
    } catch (e) {
